...
public class MyLinkedHashMap<K, V> extends MyHashMap<K, V> implements Map<K, V> {
    ...
    MyHashMap.Node<K, V> newNode(int hash, K key, V value, MyHashMap.Node<K, V> e) {
    ...
    MyHashMap.TreeNode<K, V> newTreeNode(int hash, K key, V value, MyHashMap.Node<K, V> next) {
        MyHashMap.TreeNode<K, V> p = new MyHashMap.TreeNode<K, V>(hash, key, value, next);
        linkNodeLast(p);
        return p;
    }
    ...
    MyHashMap.TreeNode<K, V> replacementTreeNode(MyHashMap.Node<K, V> p, MyHashMap.Node<K, V> next) {
        MyLinkedHashMap.Entry<K, V> q = (MyLinkedHashMap.Entry<K, V>) p;
        MyHashMap.TreeNode<K, V> t = new MyHashMap.TreeNode<K, V>(q.hash, q.key, q.value, next);
        transferLinks(q, t);
        return t;
    }

    void afterNodeRemoval(MyHashMap.Node<K, V> e) { // unlink
    ...
    void afterNodeAccess(MyHashMap.Node<K, V> e) { // move node to last
    ...
    final class LinkedKeyIterator extends MyLinkedHashMap.LinkedHashIterator implements Iterator<K> {
        public final K next() {
            return (K) nextNode().getKey();
        }
    }

    final class LinkedValueIterator extends MyLinkedHashMap.LinkedHashIterator implements Iterator<V> {
        public final V next() {
            return (V) nextNode().value;
        }
    }

    final class LinkedEntryIterator extends MyLinkedHashMap.LinkedHashIterator implements Iterator<Map.Entry<K, V>> {
